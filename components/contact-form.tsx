        ...
        <div className="space-y-12">
          ...
          <div className="text-center space-y-4">
            <ScrollReveal animation="fade-in-up">
              <h2 className="text-4xl sm:text-5xl font-bold text-foreground text-balance">Get In Touch</h2>
            </ScrollReveal>
            <ScrollReveal animation="fade-in-up" delay={0.1}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
                Have a project in mind? I'd love to hear from you. Let's discuss how we can work together.
              </p>
            </ScrollReveal>
          </div>
            ...
            {contactInfo.map((info, index) => {
              ...
              return (
                <ScrollReveal key={index} animation="fade-in-up" delay={index * 0.1}>
                  <a
                    href={info.link}
                    className="p-6 bg-background border border-border rounded-lg hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 text-center w-64"
                  >
